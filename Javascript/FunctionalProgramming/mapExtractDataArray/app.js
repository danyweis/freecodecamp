...
//  Creats a Variable               create new Object to put the data in
  var ratings = watchList.map(x => new Object ({title: x['Title'], rating: x['imdbRating']}))
 //                        ^ use map to go over the array and take out the needed data  
  
// THE FOR LOOP WAS GIVEN AND I DID COMMENT HIM OUT
