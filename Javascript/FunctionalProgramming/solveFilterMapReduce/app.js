// Functional Programming: Use Higher-Order Functions map, filter, 
...
const squareList = (arr) => {
    ...
    // FILTER TO FIND OVER 0 AND INTERGERS (NO FLOAT) THEN MAP TO MULTIPLY THEM BY THEM SELVE
    const newarr = arr.filter(number => number > 0 && number % 1 === 0).map(num => num * num)
